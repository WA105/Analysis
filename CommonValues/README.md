...
1. select events and tracks according to the output txt file from the [Highway track selection algorithm](WA105/Analysis/Event-track-selection/HighwayAlgorithm/)
